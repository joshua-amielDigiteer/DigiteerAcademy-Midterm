class ProductsController < ApplicationController
  ...
  private
    def product_params
      params.require(:product).permit(:name, :description, :price, :active, :product_type_id, :product_category_id, :image, product_skus_attributes: [:id, :product_id, :code, :color, :_destroy])
    end
